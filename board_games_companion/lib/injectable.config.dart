...
import 'utilities/custom_http_client_adapter.dart' as _i3; // ignore_for_file: unnecessary_lambdas
...
_i1.GetIt $initGetIt(_i1.GetIt get,
  ...
  gh.factory<_i6.PlaythroughStore>(() => _i6.PlaythroughStore(
      get<_i7.PlayerService>(), get<_i8.ScoreService>(), get<_i9.PlaythroughsStore>()));
  gh.factory<_i10.PlaythroughsLogGameViewModel>(() => _i10.PlaythroughsLogGameViewModel(
  ...
  gh.singleton<_i16.FirebaseAnalyticsObserver>(registerModule.firebaseAnalyticsObserver);
  gh.singleton<_i7.PlayerService>(_i7.PlayerService(get<_i14.FileService>()));
  gh.singleton<_i11.PlayersViewModel>(_i11.PlayersViewModel(get<_i7.PlayerService>()));
  ...
  gh.singleton<_i5.AnalyticsService>(
      _i5.AnalyticsService(get<_i15.FirebaseAnalytics>(), get<_i18.RateAndReviewService>()));
  ...
  gh.singleton<_i21.BoardGamesService>(
      _i21.BoardGamesService(get<_i20.BoardGamesGeekService>(), get<_i17.PreferencesService>()));
  gh.singleton<_i22.PlaythroughService>(_i22.PlaythroughService(get<_i8.ScoreService>()));
  gh.singleton<_i12.PlaythroughStatisticsStore>(_i12.PlaythroughStatisticsStore(
      get<_i7.PlayerService>(), get<_i8.ScoreService>(), get<_i22.PlaythroughService>()));
  gh.singleton<_i9.PlaythroughsStore>(
      _i9.PlaythroughsStore(get<_i22.PlaythroughService>(), get<_i5.AnalyticsService>()));
  return get;
}
