...
/// @nodoc
abstract class $BoardGameStatisticsCopyWith<$Res> {
  factory $BoardGameStatisticsCopyWith(
          BoardGameStatistics value, $Res Function(BoardGameStatistics) then) =
      _$BoardGameStatisticsCopyWithImpl<$Res, BoardGameStatistics>;
}

/// @nodoc
class _$BoardGameStatisticsCopyWithImpl<$Res, $Val extends BoardGameStatistics>
    implements $BoardGameStatisticsCopyWith<$Res> {
  _$BoardGameStatisticsCopyWithImpl(this._value, this._then);
...
class _$_none implements _none {
  ...
  @override
  String toString() {
    return 'BoardGameStatistics.none()';
  }
...
class _$_loading implements _loading {
  ...
  @override
  String toString() {
    return 'BoardGameStatistics.loading()';
  }
...
mixin _$ScoreBoardGameStatistics {
  ...
  @JsonKey(ignore: true)
  $ScoreBoardGameStatisticsCopyWith<ScoreBoardGameStatistics> get copyWith =>
      throw _privateConstructorUsedError;
}

/// @nodoc
abstract class $ScoreBoardGameStatisticsCopyWith<$Res> {
  factory $ScoreBoardGameStatisticsCopyWith(ScoreBoardGameStatistics value,
          $Res Function(ScoreBoardGameStatistics) then) =
...
/// @nodoc
class _$ScoreBoardGameStatisticsCopyWithImpl<$Res,
        $Val extends ScoreBoardGameStatistics>
    implements $ScoreBoardGameStatisticsCopyWith<$Res> {
  _$ScoreBoardGameStatisticsCopyWithImpl(this._value, this._then);
  ...
  $Res call({
    ...
    return _then(_value.copyWith(
      ...
      playersStatistics: freezed == playersStatistics
...
abstract class $PlayerWinsStatisticsCopyWith<$Res> {
  factory $PlayerWinsStatisticsCopyWith(PlayerWinsStatistics value,
      ...
      _$PlayerWinsStatisticsCopyWithImpl<$Res, PlayerWinsStatistics>;
  @useResult
...
class _$PlayerWinsStatisticsCopyWithImpl<$Res,
        $Val extends PlayerWinsStatistics>
    ...
    return _then(_value.copyWith(
      ...
      numberOfWins: null == numberOfWins
          ...
          : numberOfWins // ignore: cast_nullable_to_non_nullable
              as int,
      winsPercentage: null == winsPercentage
  ...
  bool operator ==(dynamic other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            ...
            (identical(other.winsPercentage, winsPercentage) ||
                other.winsPercentage == winsPercentage));
  }

  @override
  int get hashCode =>
      Object.hash(runtimeType, player, numberOfWins, winsPercentage);
...
abstract class $PlayerCountStatisticsCopyWith<$Res> {
  factory $PlayerCountStatisticsCopyWith(PlayerCountStatistics value,
      ...
      _$PlayerCountStatisticsCopyWithImpl<$Res, PlayerCountStatistics>;
  @useResult
  $Res call(
      {int numberOfPlayers,
      int numberOfGamesPlayed,
...
class _$PlayerCountStatisticsCopyWithImpl<$Res,
        $Val extends PlayerCountStatistics>
  ...
  $Res call({
    ...
    return _then(_value.copyWith(
      ...
      numberOfGamesPlayed: null == numberOfGamesPlayed
          ...
          : numberOfGamesPlayed // ignore: cast_nullable_to_non_nullable
              as int,
      gamesPlayedPercentage: null == gamesPlayedPercentage
    ...
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            ...
            (identical(other.numberOfGamesPlayed, numberOfGamesPlayed) ||
                other.numberOfGamesPlayed == numberOfGamesPlayed) &&
            (identical(other.gamesPlayedPercentage, gamesPlayedPercentage) ||
                other.gamesPlayedPercentage == gamesPlayedPercentage));
  }

  @override
  int get hashCode => Object.hash(
      runtimeType, numberOfPlayers, numberOfGamesPlayed, gamesPlayedPercentage);
