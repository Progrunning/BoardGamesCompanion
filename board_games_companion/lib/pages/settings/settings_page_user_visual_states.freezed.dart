...
/// @nodoc
mixin _$SettingsPageUserVisualState {
  @optionalTypeArgs
...
/// @nodoc
abstract class $SettingsPageUserVisualStateCopyWith<$Res> {
...
class _$NoUserImpl implements NoUser {
  ...
  @override
  String toString() {
    return 'SettingsPageUserVisualState.noUser()';
  }
...
class _$UserImpl implements User {
  ...
  @override
  String toString() {
    return 'SettingsPageUserVisualState.user()';
  }
