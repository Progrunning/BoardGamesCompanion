...
mixin _$CollectionsViewModel on _GamesViewModel, Store {
  Computed<List<SearchHistoryEntry>>? _$searchHistoryComputed;

  @override
  List<SearchHistoryEntry> get searchHistory =>
      (_$searchHistoryComputed ??= Computed<List<SearchHistoryEntry>>(() => super.searchHistory,
              name: '_GamesViewModel.searchHistory'))
          .value;
  Computed<List<BoardGameDetails>>? _$allMainGamesComputed;

  @override
  List<BoardGameDetails> get allMainGames =>
      (_$allMainGamesComputed ??= Computed<List<BoardGameDetails>>(() => super.allMainGames,
              name: '_GamesViewModel.allMainGames'))
          .value;
  Computed<ObservableMap<String, BoardGameDetails>>? _$_mainBoardGameByExpansionIdComputed;

  @override
  ObservableMap<String, BoardGameDetails> get _mainBoardGameByExpansionId =>
      (_$_mainBoardGameByExpansionIdComputed ??= Computed<ObservableMap<String, BoardGameDetails>>(
  ...
  List<SortBy> get sortByOptions => (_$sortByOptionsComputed ??=
          Computed<List<SortBy>>(() => super.sortByOptions, name: '_GamesViewModel.sortByOptions'))
      .value;
  Computed<SortBy?>? _$selectedSortByComputed;

  @override
  SortBy? get selectedSortBy => (_$selectedSortByComputed ??=
          Computed<SortBy?>(() => super.selectedSortBy, name: '_GamesViewModel.selectedSortBy'))
      .value;
  Computed<bool>? _$anyFiltersAppliedComputed;

  @override
  bool get anyFiltersApplied => (_$anyFiltersAppliedComputed ??=
          Computed<bool>(() => super.anyFiltersApplied, name: '_GamesViewModel.anyFiltersApplied'))
      .value;
  Computed<double?>? _$filterByRatingComputed;

  @override
  double? get filterByRating => (_$filterByRatingComputed ??=
          Computed<double?>(() => super.filterByRating, name: '_GamesViewModel.filterByRating'))
      .value;
  Computed<ObservableList<BoardGameDetails>>? _$filteredBoardGamesComputed;

  @override
  ObservableList<BoardGameDetails> get filteredBoardGames => (_$filteredBoardGamesComputed ??=
          Computed<ObservableList<BoardGameDetails>>(() => super.filteredBoardGames,
              name: '_GamesViewModel.filteredBoardGames'))
      .value;
  Computed<bool>? _$anyBoardGamesInCollectionsComputed;

  @override
  bool get anyBoardGamesInCollections => (_$anyBoardGamesInCollectionsComputed ??= Computed<bool>(
  ...
  @override
  bool get anyBoardGames => (_$anyBoardGamesComputed ??=
          Computed<bool>(() => super.anyBoardGames, name: '_GamesViewModel.anyBoardGames'))
      .value;
  Computed<double>? _$minNumberOfPlayersComputed;

  @override
  double get minNumberOfPlayers =>
      (_$minNumberOfPlayersComputed ??= Computed<double>(() => super.minNumberOfPlayers,
              name: '_GamesViewModel.minNumberOfPlayers'))
          .value;
  Computed<int?>? _$filterByNumberOfPlayersComputed;

  @override
  int? get filterByNumberOfPlayers =>
      (_$filterByNumberOfPlayersComputed ??= Computed<int?>(() => super.filterByNumberOfPlayers,
              name: '_GamesViewModel.filterByNumberOfPlayers'))
          .value;
  Computed<String>? _$numberOfPlayersSliderValueComputed;

  @override
  String get numberOfPlayersSliderValue => (_$numberOfPlayersSliderValueComputed ??=
          Computed<String>(() => super.numberOfPlayersSliderValue,
              name: '_GamesViewModel.numberOfPlayersSliderValue'))
      .value;
  Computed<double>? _$maxNumberOfPlayersComputed;

  @override
  double get maxNumberOfPlayers =>
      (_$maxNumberOfPlayersComputed ??= Computed<double>(() => super.maxNumberOfPlayers,
              name: '_GamesViewModel.maxNumberOfPlayers'))
          .value;
  Computed<List<BoardGameDetails>>? _$allBoardGamesComputed;

  @override
  List<BoardGameDetails> get allBoardGames =>
      (_$allBoardGamesComputed ??= Computed<List<BoardGameDetails>>(() => super.allBoardGames,
              name: '_GamesViewModel.allBoardGames'))
          .value;
  Computed<List<BoardGameDetails>>? _$boardGamesInCollectionComputed;

  @override
  List<BoardGameDetails> get boardGamesInCollection => (_$boardGamesInCollectionComputed ??=
          Computed<List<BoardGameDetails>>(() => super.boardGamesInCollection,
              name: '_GamesViewModel.boardGamesInCollection'))
      .value;
  Computed<bool>? _$isCollectionEmptyComputed;

  @override
  bool get isCollectionEmpty => (_$isCollectionEmptyComputed ??=
          Computed<bool>(() => super.isCollectionEmpty, name: '_GamesViewModel.isCollectionEmpty'))
      .value;
  Computed<List<BoardGameDetails>>? _$mainGamesInCollectionComputed;

  @override
  List<BoardGameDetails> get mainGamesInCollection => (_$mainGamesInCollectionComputed ??=
          Computed<List<BoardGameDetails>>(() => super.mainGamesInCollection,
              name: '_GamesViewModel.mainGamesInCollection'))
      .value;
  Computed<List<BoardGameDetails>>? _$expansionsInCollectionComputed;

  @override
  List<BoardGameDetails> get expansionsInCollection => (_$expansionsInCollectionComputed ??=
          Computed<List<BoardGameDetails>>(() => super.expansionsInCollection,
              name: '_GamesViewModel.expansionsInCollection'))
      .value;
  Computed<bool>? _$anyMainGamesInCollectionComputed;

  @override
  bool get anyMainGamesInCollection =>
      (_$anyMainGamesInCollectionComputed ??= Computed<bool>(() => super.anyMainGamesInCollection,
              name: '_GamesViewModel.anyMainGamesInCollection'))
          .value;
  Computed<int>? _$totalMainGamesInCollectionComputed;

  @override
  int get totalMainGamesInCollection => (_$totalMainGamesInCollectionComputed ??= Computed<int>(
  ...
  @override
  int get totalExpansionsInCollection => (_$totalExpansionsInCollectionComputed ??= Computed<int>(
  ...
  @override
  bool get anyExpansionsInCollection =>
      (_$anyExpansionsInCollectionComputed ??= Computed<bool>(() => super.anyExpansionsInCollection,
  ...
  List<BoardGameDetails> get _allExpansions =>
      (_$_allExpansionsComputed ??= Computed<List<BoardGameDetails>>(() => super._allExpansions,
  ...
  String? get userName => (_$userNameComputed ??=
          Computed<String?>(() => super.userName, name: '_GamesViewModel.userName'))
      .value;
  Computed<bool>? _$isUserNameEmptyComputed;

  @override
  bool get isUserNameEmpty => (_$isUserNameEmptyComputed ??=
          Computed<bool>(() => super.isUserNameEmpty, name: '_GamesViewModel.isUserNameEmpty'))
      .value;

  late final _$selectedTabAtom = Atom(name: '_GamesViewModel.selectedTab', context: context);
  ...
  late final _$searchAsyncAction = AsyncAction('_GamesViewModel.search', context: context);
  ...
  void setSelectedTab(GamesTab newlySelectedTab) {
    final _$actionInfo =
        _$_GamesViewModelActionController.startAction(name: '_GamesViewModel.setSelectedTab');
    try {
  ...
  void loadBoardGames() {
    final _$actionInfo =
        _$_GamesViewModelActionController.startAction(name: '_GamesViewModel.loadBoardGames');
    try {
  ...
  Future<void> clearFilters() {
    final _$actionInfo =
        _$_GamesViewModelActionController.startAction(name: '_GamesViewModel.clearFilters');
    try {
  ...
  Future<void> updateFilterByRating(double? rating) {
    final _$actionInfo =
        _$_GamesViewModelActionController.startAction(name: '_GamesViewModel.updateFilterByRating');
    try {
