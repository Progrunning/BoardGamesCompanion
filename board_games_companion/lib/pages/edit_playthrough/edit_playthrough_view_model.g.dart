...
mixin _$EditPlaythoughViewModel on _EditPlaythoughViewModel, Store {
  Computed<Map<String, PlayerScore>>? _$tiedPlayerScoresMapComputed;

  @override
  Map<String, PlayerScore> get tiedPlayerScoresMap =>
      (_$tiedPlayerScoresMapComputed ??= Computed<Map<String, PlayerScore>>(
              () => super.tiedPlayerScoresMap,
              name: '_EditPlaythoughViewModel.tiedPlayerScoresMap'))
          .value;
