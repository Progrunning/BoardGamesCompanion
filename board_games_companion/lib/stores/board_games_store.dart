...
abstract class _BoardGamesStore with Store {
  _BoardGamesStore(this._boardGamesService, this._playthroughService);
  ...
  List<BoardGameDetails> get expansions =>
      allBoardGames.where((boardGame) => !boardGame.isBaseGame).toList();
  ...
  Future<void> refreshBoardGameDetails(String boardGameId) async {
    try {
      ...
      if (boardGameDetails.isBaseGame) {
